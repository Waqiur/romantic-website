...
function stars(s: number, maxArea: number, minArea = 0, starSize = 0) {
    // Generate stars across the full width and height, including negative coordinates
    let stars = `${Math.random() * maxArea * 2 - maxArea}px ${
        Math.random() * maxArea
    }px 0 ${starSize}px rgba(255, 255, 255, ${alphaRandom()})`;

    for (let i = 1; i < s; i++) {
        stars += `, ${Math.random() * maxArea * 2 - maxArea}px ${
            Math.random() * maxArea
        }px 0 ${starSize}px rgba(255, 255, 255, ${alphaRandom()})`;
    }
...
const EarthContainer = styled(motion.div)<{ isVisible: boolean }>`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
const EarthContent = styled(motion.div)`
    text-align: center;
    color: white;
    position: relative;
    z-index: 10;
...
const EarthSVG = styled(motion.div)`
    margin: 2rem auto;
    filter: drop-shadow(0 0 30px rgba(66, 225, 245, 0.4));
    position: relative;
    ...
    #Moon {
        animation: moonSpin 2358720s linear infinite;
    }
    ...
    /* Enhanced Earth styling */
    #Earth circle {
        filter: drop-shadow(0 0 20px rgba(66, 225, 245, 0.3));
    }

    #Earth path[id*="Polygon"] {
        filter: drop-shadow(0 0 15px rgba(6, 202, 149, 0.4));
    }
    ...
    #Earth path[id*="cloud"]:nth-child(1) {
        animation-delay: 0s;
    }

    #Earth path[id*="cloud"]:nth-child(2) {
        animation-delay: 2s;
    }
    ...
    #Earth g[id*="Tree"]:nth-child(1) {
        animation-delay: 0s;
    }

    #Earth g[id*="Tree"]:nth-child(2) {
        animation-delay: 1s;
    }

    #Earth g[id*="Tree"]:nth-child(3) {
        animation-delay: 2s;
    }
    ...
    /* Mountain glow */
    #Earth g[id*="Mountain"] path {
        filter: drop-shadow(0 0 10px rgba(216, 216, 216, 0.3));
    }

    /* Moon glow */
    #Moon circle {
        filter: drop-shadow(0 0 20px rgba(216, 216, 216, 0.5));
    }
`;
                ...
                >
                    ...
                    >
                        <defs>
                            ...
                            ></circle>
                            <path
                                d="M29.3270039,5.83326042 L36.0159448,17.6749508 L0,17.6749508 L6.68894089,5.83326042 C10.2200893,-0.418068061 18.1503538,-2.62320968 24.4016823,0.907938771 C26.4609142,2.07112411 28.1638186,3.77402849 29.3270039,5.83326042 Z"
                                id="path-4"
                            ></path>
                            <path
                                d="M8.52751601,-2.88660895 L18.5883805,17.2337505 L-24.7881389,17.2337505 L-14.7272744,-2.88660895 C-11.5162393,-9.308242 -3.70741893,-11.9109459 2.71421412,-8.69991084 C5.22981951,-7.44202254 7.26962771,-5.40221434 8.52751601,-2.88660895 Z"
                                id="path-6"
                            ></path>
                        </defs>
                        <g
                        ...
                        >
                            <g
                                id="Group"
                                transform="translate(37.000000, 94.000000)"
                            >
                                <g
                                    id="Earth"
                                    filter="url(#filter-1)"
                                ...
                                <g
                                    id="Tree"
                                    transform="translate(267.878162, 65.809971) rotate(55.000000) translate(-267.878162, -65.809971) translate(261.878162, 47.809971)"
                                >
                                    <rect
                                        id="Rectangle-2"
                                        fill="#8B572A"
                                ...
                                <g
                                    id="Tree"
                                    transform="translate(271.104768, 54.743957) rotate(55.000000) translate(-271.104768, -54.743957) translate(260.604768, 24.743957)"
                                >
                                    <rect
                                        id="Rectangle-2"
                                        fill="#8B572A"
                                ...
                                <g
                                    id="Mountain"
                                    transform="translate(92.496549, 1.708492) rotate(-21.000000) translate(-100.496549, -10.708492) translate(75.996549, 6.708492)"
                                >
                            ...
                            <g
                                id="Moon"
                                transform="translate(220.000000, 280.000000)"
                            >
                                <circle
                                    id="Oval-2"
                                    stroke="#979797"
